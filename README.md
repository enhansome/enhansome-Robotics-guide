...
[Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,575 | 🐛 56 | 🌐 C# | 📅 2024-11-26 is a Central repository for open-source Unity packages, tutorials, and other resources demonstrating how to use Unity for robotics simulations. Includes new support for ROS integration.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,452 | 🐛 1,203 | 🌐 CMake | 📅 2026-09-09 is a C++ Library Manager for Windows, Linux, and MacOS.
