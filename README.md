...
1. [Robotic Arms & Dev Kits](https://github.com/mikeroyal/Robotics-guide#robotic-arms--dev-kits) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04

2. [Robotics Learning Resources](https://github.com/mikeroyal/Robotics-guide#robotics-learning-resources) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04

3. [Robotics Tools and Frameworks](https://github.com/mikeroyal/Robotics-guide#robotics-tools-and-frameworks) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04

4. [Autodesk Robotics Development](https://github.com/mikeroyal/Robotics-guide#autodesk-robotics-development) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04

5. [C/C++ Development](https://github.com/mikeroyal/Robotics-guide#cc-development) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04

6. [Python Development](https://github.com/mikeroyal/Robotics-guide#python-development) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04
...
# Awesome Robotic Arms & Dev Kits with stars

[Back to the Top](https://github.com/mikeroyal/Robotics-Guide#table-of-contents) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04
...
[g2core](https://github.com/synthetos/g2) ⭐ 675 | 🐛 138 | 🌐 C++ | 📅 2023-07-20 is an open-source motion control software for CNC and Robotics, designed to run on Arduino Due class microcontrollers.
...
[RBDL](https://github.com/rbdl/rbdl) ⭐ 705 | 🐛 33 | 🌐 C++ | 📅 2025-06-09 is an open-source (zlib) C++ libray for both forward and inverse dynamics and kinematics. Also supports contacts and loops.

[Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,566 | 🐛 57 | 🌐 C# | 📅 2024-11-26 is a Central repository for open-source Unity packages, tutorials, and other resources demonstrating how to use Unity for robotics simulations. Includes new support for ROS integration.
...
[C++ Client Libraries for Google Cloud Services](https://github.com/googleapis/google-cloud-cpp) ⭐ 659 | 🐛 206 | 🌐 C++ | 📅 2026-08-27
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,115 | 🐛 74 | 🌐 Python | 📅 2026-08-26 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,599 | 🐛 320 | 🌐 Python | 📅 2026-08-27 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[spaCy](https://github.com/explosion/spaCy) ⭐ 33,853 | 🐛 237 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Robotics-Guide/pulls) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2024-01-04.
