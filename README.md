...
[g2core](https://github.com/synthetos/g2) ⭐ 676 | 🐛 138 | 🌐 C++ | 📅 2023-07-20 is an open-source motion control software for CNC and Robotics, designed to run on Arduino Due class microcontrollers.
...
[RBDL](https://github.com/rbdl/rbdl) ⭐ 706 | 🐛 33 | 🌐 C++ | 📅 2025-06-09 is an open-source (zlib) C++ libray for both forward and inverse dynamics and kinematics. Also supports contacts and loops.

[Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,574 | 🐛 56 | 🌐 C# | 📅 2024-11-26 is a Central repository for open-source Unity packages, tutorials, and other resources demonstrating how to use Unity for robotics simulations. Includes new support for ROS integration.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,452 | 🐛 1,211 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,625 | 🐛 343 | 🌐 Python | 📅 2026-09-04 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[spaCy](https://github.com/explosion/spaCy) ⭐ 33,882 | 🐛 239 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
