...
[g2core](https://github.com/synthetos/g2) ⭐ 676 | 🐛 139 | 🌐 C++ | 📅 2023-07-20 is an open-source motion control software for CNC and Robotics, designed to run on Arduino Due class microcontrollers.
...
[Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,570 | 🐛 56 | 🌐 C# | 📅 2024-11-26 is a Central repository for open-source Unity packages, tutorials, and other resources demonstrating how to use Unity for robotics simulations. Includes new support for ROS integration.
...
[spaCy](https://github.com/explosion/spaCy) ⭐ 33,877 | 🐛 239 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
